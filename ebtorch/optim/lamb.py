...
# -*- coding: utf-8 -*-
# ──────────────────────────────────────────────────────────────────────────────
# Copyright (c) 2019      cybertronai. All rights reserved. MIT licensed.
#                         [orig. code: https://github.com/cybertronai/pytorch-lamb ;
#                         license text: https://github.com/cybertronai/pytorch-lamb/blob/master/LICENSE]
#
# ──────────────────────────────────────────────────────────────────────────────
# Copyright (c) 2019-2020 NVIDIA CORPORATION. All rights reserved.
# Copyright (c) 2021-*    Habana Labs Ltd.  All rights reserved.
#                         [orig. code: https://github.com/HabanaAI/Model-References]
#
...
class Lamb(Optimizer):
    ...
    def step(self, closure=None):  # NOSONAR
        ...
        # [emaballarin] Is it probably time?
        max_grad_norm = torch.tensor(self.defaults["max_grad_norm"], device=device)
        clip_global_grad_norm = torch.where(  # type: ignore
